...
const headings = ["Tools", "AWS Builder", "Start Build", "Build Supplies", "Tooling", "BlueHosting"];


function HeroSection() {
  return (
    <>
        <section className=' flex flex-col gap-5 px-10 pt-10'>
                ...
                <div className=' flex justify-between text-[#4B5665]'>
                    <div className=' flex flex-col sm:flex-row gap-5'>
                        <div className=' flex gap-1 items-center'>
                            <img className=' w-[20px] h-[20px]' src={CheckIcon} alt='c-icon'/>
                            <p>Last Updated</p>
                            <p>-</p>
            ...
            <div className=' flex flex-col'>
                ...
                <ol className=' flex flex-col sm:flex-row items-center md:items-baseline mt-5 gap-3 text-[#4B5665]'>
                    <li>Home</li>
                    <img className=' w-[10px] h-[8.5px]' src={VectorI} alt='vector-icon'/>
